...
class FilesFinder:
    ...
    def set_search_paths(self, list_of_paths_to_search):
        ...
        if not(isinstance(list_of_paths_to_search, str) or (isinstance(list_of_paths_to_search, list) and all(isinstance(path, str) for path in list_of_paths_to_search))):
    ...
    def set_excluded_directiories(self, list_of_paths_to_exlude_from_search):
        ...
        if not(list_of_paths_to_exlude_from_search is None or isinstance(list_of_paths_to_exlude_from_search, str) or (isinstance(list_of_paths_to_exlude_from_search, list) and all(isinstance(path, str) for path in list_of_paths_to_exlude_from_search))):
